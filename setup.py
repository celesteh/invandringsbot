...
["That's a racist and gross slur, which hurts real people. You should stop."],
[['Leviticus 19:33-34 and Matthew 25:35', 'Matthew 25:35 and Leviticus 19:33-34'],[" command", " tell", " instruct"], " us to ", ['welcome strangers', 'welcome refugees', 'accept refugees', 'take refugees'], ". ", ["I'll pray", "I'm praying"], ' for you.']
]


templates = [
[["Today ", "This morning ", "This afternoon ", "At church ", "In bible study ", "Tomorrow ", "This Sunday ", "Next week ", ""], "I'm ", ["remembering ", "praying for ", "saying a prayer for ", "lighting a candle for ", "honering ", "asking for God's blessings on ", "asking Jesus to bless ", "asking God to sanctify ", "leading a prayer for "], ["veterans. ", "our soliders. ", "POWs. ", "those who died for US. ", "the gratest generation. ", "WWII vets. ", "victims of terrorism. ", "my grandfather. "],["#MAGA", "#PrayForAmerica", "#PrayForVetrans", "#GodBlessAmerica", "@RealDonaldTrump", '#TrumpTrain', '#tcot']],
